<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Edit work schedules') }}</flux:subheading>
    ...
    function initTimePickers() {
        ...
        if (startInput && !startInput.classList.contains('flatpickr-input')) {
            flatpickr(startInput, {
                ...
                dateFormat: "H:i",
                time_24hr: true,
                defaultDate: startInput.value || null, // ✅ Tambahkan ini
        ...
        if (endInput && !endInput.classList.contains('flatpickr-input')) {
            flatpickr(endInput, {
                ...
                dateFormat: "H:i",
                time_24hr: true,
                defaultDate: endInput.value || null, // ✅ Tambahkan ini juga
                onChange: function(selectedDates, dateStr) {
