<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Manage your permission') }}</flux:subheading>
                    ...
                    @foreach ($permissions as $permission)
                        <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                            ...
                            <td class="px-6 py-2 space-x-1">
                                @can('permission.edit')
                                    <a href="{{ route('permission.edit', $permission->uuid) }}"
                                ...
                                @endcan
                                <a href="{{ route('permission.show', $permission->uuid) }}"
                                ...
                                @can('permission.delete')
                                    <button wire:click="delete('{{ $permission->uuid }}')"
